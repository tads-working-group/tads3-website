...
-   [contentType]{.code}: a string giving the Content-Type specified by
    ...
    should instead parse the uploaded data to confirm that it has a
...
-   [expires=]{.code}*date*, where *date* is a date in Unix format
