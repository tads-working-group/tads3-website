...
[]{#classes} Ranges are useful for matching a specific group of
...
[%B]{.code} matches anywhere that is not a word boundary.
...
For example, to search for a match to \"abc\", ignoring case, we\'d
write this:
