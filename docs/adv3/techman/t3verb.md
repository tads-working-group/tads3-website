...
In UNLOCK DOOR WITH KEY, the key is the \"instrument\" or \"agent\" of
...
Note that the verbPhrase needs two \"(what)\" (or \"(whom)\") markers,
...
In the VerbRule, the \"slot\" for the literal text must be indicated
