...
[Creating Your First TADS 3 Project](../techman/t3start.htm) in the TADS
3 Technical Manual. When you come to create a larger project you might
want to split it over several source files, which is explained in the
article on [separate compilation](../techman/t3inc.htm) in the
