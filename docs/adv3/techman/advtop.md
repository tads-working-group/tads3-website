...
::: nav
[Table of Contents](toc.htm){.nav} \| Advanced Topics\
[[*Prev:* Using the Banner API](t3banner.htm){.nav}     [*Next:*
Banishing (and Changing) Awkward Messages](t3banish.htm){.nav}    
]{.navnp}
:::
...
This section covers situations that you probably won\'t run into on
every game, but might encounter as you think about trickier
customizations.
