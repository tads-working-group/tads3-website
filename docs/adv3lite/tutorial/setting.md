...
[Table of Contents](toc.htm) \| [Introduction](intro.htm) \> Setting it
all up  
[*Prev:* Getting What You Need](getting.htm)     [*Next:* Using the
Tools](using.htm)    
...
[Table of Contents](toc.htm) \| [Tools of the Trade](intro.htm) \>
Setting it all up  
[*Prev:* Getting What You Need](getting.htm)     [*Next:* Using the
Tools](using.htm)    
