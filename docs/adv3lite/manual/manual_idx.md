...
Index\
[[*Prev:* Change Log](changelog.htm){.nav}]{.navnp}
:::
...
[-D TADS_INCLUDE_NET](webui.htm#manual_port) (Porting an existing game)\
...
[activated](actortopicentry.htm#activated) (activated and deactivate())\
...
[attachmentLister](lister.htm#custom%20id=custom) (Customizing Listers)\
...
ActorTopicEntry)\
[Building the same game both ways](webui.htm#buildingboth) (The Web UI)\
...
class)\
[canHearOutTo(loc)](senseregion.htm#inoutprops) (The SenseRegion class)\
...
[canSeeInFrom(loc)](senseregion.htm#inoutprops) (The SenseRegion class)\
...
[collectiveActions](extra.htm#collective) (Other Miscellaneous Classes)\
...
[darkDesc](room.htm#otherroomprops) (Other Room Properties and Methods)\
[darkName](room.htm#otherroomprops) (Other Room Properties and Methods)\
...
[Debugging with Workbench on Windows](webui.htm#debugging) (The Web UI)\
...
[disambigMatchPhrases](thing.htm#matchphraseexcludes) (Phrase Matching)\
...
[Don\'t use [\<TAB\>]{.code}](webui.htm#Adv3WebUsageTips) (The Web UI)\
...
[endConvBoredom](actorobj.htm#conversation) (Actor-Specific Properties)\
...
[errorCheckInterval](newbie.htm#playerhelper) (The playerHelper object)\
...
[filterResolveList(np, cmd, mode)](thing.htm#filter) (Basic Properties)\
...
[FollowAgendaItem](agenda.htm#followagenda) (Other Kinds of AgendaItem)\
...
[gMessageParams()](message.htm#dummy) (Message Substitution Parameters)\
...
[input(x)](webui.htm#inputmgr_idx) (Use inputManager methods for input)\
...
[Intrinsic Class Extensions](utility.htm#intrinsic) (Utility Functions)\
...
[isDirectlyIn(loc)](multiloc.htm#location) (The location of a MultiLoc)\
...
[ItemLister](lister.htm#itemlister%20id=itemlister) (Lists and Listers)\
...
[Keeping Track of](scene.htm#time_idx) [Time]{#time_idx} (Scenes)\
...
[Keys](key.htm)\
[keyTopics](suggest.htm#other) (TopicEntries that Suggest Other Topics)\
...
[matchPhrasesExcludes](thing.htm#matchphraseexcludes) (Phrase Matching)\
...
Options)\
[paraBrksBtwnSubcontents](beginning.htm#gamemain) (The gameMain Object)\
...
(Things)\
[Remote](senseregion.htm#descriptions) [Descriptions]{#descriptions}
(SenseRegion)\
[Remote](senseregion.htm#sensing) [Sensing]{#sensing} (SenseRegion)\
...
Actions)\
[Reporting Implicit Actions](implicit.htm#reporting) (Implicit Actions)\
...
AgendaItem)\
[sayDeparting(conn)](actorobj.htm#specific) (Actor-Specific Properties)\
...
[sightSize](senseregion.htm#sensing) (Remote [Sensing]{#sensing})\
...
[smellSize](senseregion.htm#sensing) (Remote [Sensing]{#sensing})\
...
[soundSize](senseregion.htm#sensing) (Remote [Sensing]{#sensing})\
...
[specialDescBeforeContents](roomdesc.htm#descorder) (Room Descriptions)\
...
Topics)\
[Summarizing Give and Show](actortopicentry.htm#summarizing) (The
ActorTopicEntry Class)\
[summaryProp](actortopicentry.htm#sumprop) (Summarizing Give and Show)\
[summaryReport](actortopicentry.htm#summaryreport) (Summarizing Give and
Show)\
[Surface](extra.htm#shallow) (Shallow Equivalents to adv3 Classes)\
[Switch](extra.htm#shallow) (Shallow Equivalents to adv3 Classes)\
[Switching ActorState](actorstate.htm#changing) (Actor States)\
[Symconn](extensions.htm#symconn) (Extensions)\
[SyncEventList](eventlist.htm) (EventList)\
[Synonyms for Existing Actions](define.htm#synonyms) (Defining New
Actions)\
[sysman.htm](mingame.htm#sysman) (The System Manual)\
[Sysrules](extensions.htm#sysrules) (Extensions)\
[System Manual](mingame.htm#sysman) (Starting Out --- A Minimal Game
Definition)\
[SystemAction](actionoverview.htm#taxonomy) (A Taxonomy of Actions)\

[]{#T}

## T

[TAction](actionoverview.htm#taxonomy) (A Taxonomy of Actions)\
[TalkTopic](actortopicentry.htm#types) (The Different Types of
ActorTopicEntry)\
[TalkTopic](actortopicentry.htm#hittopic) (The Different Types of
ActorTopicEntry)\
[tasteDesc](thing.htm#sensory) (Sensory Properties)\
[tellMatchObj](specialtopic.htm) (Special Topics)\
[TellTalkShowTopic](actortopicentry.htm#types) (The Different Types of
ActorTopicEntry)\
[TellTalkTopic](actortopicentry.htm#types) (The Different Types of
ActorTopicEntry)\
[TellTopic](asktell.htm) (Basic Ask/Tell)\
[TellTopic](actortopicentry.htm#types) (The Different Types of
ActorTopicEntry)\
[tenses](beginning.htm#tenses) (Notes)\
[TEST *XXX*](debug.htm#built-in) (Built-In Debugging Commands)\
[Test Scripts](debug.htm#tests) (Debugging Commands)\
[testHolding](debug.htm#tests) (Test Scripts)\
[testList](debug.htm#tests) (Test Scripts)\
[testName](debug.htm#tests) (Test Scripts)\
[theName](topicact.htm#resolvedtopic) (Working with TopicActions and
TopicTActions)\
[theName](thing.htm#thingprops) (Basic Properties)\
[Thing-like Properties](actorobj.htm#thinglike) (The Actor Object)\
[Things](thing.htm)\
[Thought](thought.htm) (Thoughts)\
[ThoughtManager](thought.htm) (Thoughts)\
[Thoughts](thought.htm)\
[thoughts.t:](modules.htm#optional) (Optional Modules)\
[throughSingleNoun](define.htm#badness) (Defining TIActions)\
[TIAAction](extensions.htm#sysrules) (Extensions)\
[TIAction](actionoverview.htm#taxonomy) (A Taxonomy of Actions)\
[Time](scene.htm#time_idx) (Scenes)\
[time](extensions.htm#obtime_idx) (Objective Time)\
[time](extensions.htm#subtime_idx) (Subtime)\
[timesHappened](scene.htm) (Scenes)\
[timesToSuggest](suggest.htm#conditions) (The Conditions Under Which
Topics are Suggested)\
[title](menu.htm) (Menus)\
[tokens](thing.htm#filterresolve) (filterResolveList())\
[tokens](topicact.htm#resolvedtopic) (Working with TopicActions and
TopicTActions)\
[toList()](utility.htm#list) (List)\
[tooFarAwayMsg](query.htm#touchobj) (Specials and the touchObj
PreCondition: Customizing Failure Messages)\
[TopHintMenu](hint.htm) (Standard Hints)\
[Topic Actions](topicact.htm)\
[Topic Entries](topicentry.htm)\
[Topic Groups](topicgroup.htm)\
[Topic scope](scope.htm#objscope) (Object Scope and Topic Scope)\
[TopicAction](topicact.htm) (Topic Actions)\
[TopicAction](actionoverview.htm#taxonomy) (A Taxonomy of Actions)\
[topicAobj](define.htm#threeobjects) ()\
[TopicEntries that Suggest Other Topics](suggest.htm#other) (Suggesting
Conversational Topics)\
[topicEntry.t:](modules.htm#optional) (Optional Modules)\
[topicList](topicact.htm#resolvedtopic) (Working with TopicActions and
TopicTActions)\
[topicMatched](topicentry.htm) (Topic Entries)\
[topicResponse](topicentry.htm) (Topic Entries)\
[Topics](topic.htm)\
[topicScopeList()](query.htm#q) (The Q Object)\
[TopicTAction](actionoverview.htm#taxonomy) (A Taxonomy of Actions)\
[TopicTAction](topicact.htm) (Topic Actions)\
[toSingleNoun](define.htm#badness) (Defining TIActions)\
[touchObj](actres.htm#preconds) (Pre-conditions)\
[touchObj](query.htm#touchobj) (Specials and the touchObj PreCondition:
Customizing Failure Messages)\
[touchResponseMsg](actorobj.htm#hitkiss) (Attacking, Touching and
Kissing)\
[TouchTopic](actortopicentry.htm#hittopic) (The Different Types of
ActorTopicEntry)\
[TouchTopic](actortopicentry.htm#types) (The Different Types of
ActorTopicEntry)\
[transmitsLight](travel.htm) (TravelConnectors)\
[Trapping badly-formed commands](newbie.htm#trapping) (Help for New
Players)\
[Travel Connectors and Barriers](travel.htm)\
[TravelAction](actionoverview.htm#taxonomy) (A Taxonomy of Actions)\
[travelBarriers](travel.htm) (TravelConnectors)\
[TravelBarriers](travel.htm#travelbarrier) (Travel Connectors and
Barriers)\
[travelBlocked(conn)](agenda.htm#followprops) (Other Kinds of
AgendaItem)\
[TravelConnector Classes](extra.htm#travelconn) (Extras)\
[TravelConnectors](travel.htm) (Travel Connectors and Barriers)\
[travelDesc](travel.htm) (TravelConnectors)\
[traveledThisTurn](agenda.htm#followprops) (Other Kinds of AgendaItem)\
[travelerEntering(traveler, origin)](room.htm#regionprops) (Regions)\
[travelerEntering(traveler, origin)](room.htm#otherroomprops) (Other
Room Properties and Methods)\
[travelerLeaving(traveler, dest)](room.htm#regionprops) (Regions)\
[travelerLeaving(traveler, dest)](room.htm#otherroomprops) (Other Room
Properties and Methods)\
[travelVia(actor)](travel.htm) (TravelConnectors)\
[travelVia(conn, announceArrival = true)](actorobj.htm#specific)
(Actor-Specific Properties)\
[traversed](travel.htm) (TravelConnectors)\
[traversedBy](travel.htm) (TravelConnectors)\
[Triggering Implicit Actions](implicit.htm#trigger) (Implicit Actions)\
[trim()](utility.htm#string) (String)\
[truncationLength](instruct.htm#custverbs) (Instructions)\
[tryImplicitAction()](implicit.htm#trigger) (Triggering Implicit
Actions)\
[tryInt(val)](utility.htm#functions) (Functions)\
[tryNumber(val)](utility.htm#functions) (Functions)\
[tSel(\'present\', \'past\')](message.htm#regular-idx) (Conjugations and
Tenses)\
[typeInfo](suggest.htm#listorder) (Suggesting Conversational Topics)\
[Types of Lister](lister.htm#lister-types%20id=lister-types) (Lists and
Listers)\
...
[Under](thing.htm#defining_containment) (Defining containment type with
the contType property)\
[Underside](extra.htm#shallow) (Shallow Equivalents to adv3 Classes)\
[unknownDest\_](door.htm#doorlocked_idx) (Doors)\
[unshift(val)](utility.htm#vector) (Vector)\
[Unthing](extra.htm#unthing) (Other Miscellaneous Classes)\
[unvisitedExitColour](exit.htm) (Exits)\
[Use [cls()]{.code} instead of [clearScreen()]{.code}](webui.htm#cls)
(The Web UI)\
[Use aHref() for command links](webui.htm#Adv3WebUsageTips) (The Web
UI)\
[Use inputManager methods for input](webui.htm#inputmanager) (The Web
UI)\
[useParentheticalListing](beginning.htm#gamemain) (The gameMain Object)\
[usePastTense](beginning.htm#gamemain) (The gameMain Object)\
[Using the ConvNode Class](convnode.htm#convnode) (Conversation Nodes)\
...
[validSettings](gadget.htm#settables) (Settables and Dials)\
[valToList()](define.htm#valtolist) (Defining TIActions)\
[valToList(val)](utility.htm#functions) (Functions)\
[Varying the Response](asktell.htm#varying) (Basic Ask/Tell)\
[Vector](utility.htm#vector) (Utility Functions)\
[verbose](beginning.htm#gamemain) (The gameMain Object)\
[verbParams](message.htm#custom) (CustomVocab)\
[verbPhrase](define.htm#vrprops) (VerbRules)\
[verbPhrase](define.htm#synonyms) (Synonyms for Existing Actions)\
[VerbRules](define.htm#verbrule) (Defining New Actions)\
[Verify](actres.htm#verify) (Action Results)\
[version](beginning.htm#versioninfo) (The versionInfo Object)\
[versionInfo Object](beginning.htm#versioninfo) (Beginnings)\
[VideoLink](query.htm#commlink) (The Communications Link Special)\
[Viewport](extensions.htm#sysrules) (Extensions)\
[visibleInDark](thing.htm#sensory) (Sensory Properties)\
[visited](room.htm#otherroomprops) (Other Room Properties and Methods)\
[vocab](room.htm#roomdef) (Defining a Room)\
[vocab](room.htm#roomvocab-idx) (Defining a Room)\
[vocab](actorobj.htm#thinglike) (Thing-like Properties)\
[vocab Property in Detail](thing.htm#vocab) (Things)\
[vocabWhenClosed](extra.htm#secretdoor) (Other Miscellaneous Classes)\
[vocabWhenOpen](extra.htm#secretdoor) (Other Miscellaneous Classes)\

[]{#W}

## W

[waitKey(x)](webui.htm#inputmgr_idx) (Use inputManager methods for
input)\
[walls](extensions.htm#wall_idx) (Room Parts)\
[WARNING!](eventlist.htm#shuffled) (EventList)\
[watchForOutput(func)](output.htm#markup-idx) (Some Output Issues)\
[weak token](thing.htm#weaktok-idx) (The vocab Property in Detail)\
[Wearable](extra.htm#shallow) (Shallow Equivalents to adv3 Classes)\
[Web UI](webui.htm)\
[Web-based play.](webui.htm) (The Web UI)\
[Weight](extensions.htm#sysrules) (Extensions)\
[when](doer.htm#matching) (Matching Special Conditions)\
[When to Use Message Parameter Substitutions](message.htm#whentouse)
(Messages)\
[whenEnding](scene.htm) (Scenes)\
[whenStarting](scene.htm) (Scenes)\
[where](doer.htm#matching) (Matching Special Conditions)\
[Which Optional Modules Do You Need?](modules.htm#which) (Core and
Optional Modules)\
[who](doer.htm#matching) (Matching Special Conditions)\
[withSingleNoun](define.htm#badness) (Defining TIActions)\
[Working with LiteralActions and
LiteralTActions](literalact.htm#working) (Literal Actions)\
[Working with TopicActions and TopicTActions](topicact.htm#working)
(Topic Actions)\
[wornBy](thing.htm#behaviour) (Behavioural Properties)\
[wornLister](lister.htm#lister-types%20id=lister-types) (Types of
Lister)\
...
[YesNoTopic](actortopicentry.htm#types) (The Different Types of
ActorTopicEntry)\
[yesOrNo()](utility.htm#functions) (Functions)\
[YesTopic](actortopicentry.htm#types) (The Different Types of
ActorTopicEntry)\
[You can\'t reach the *target* from the *loc*](query.htm#touchobj)
(Specials and the touchObj PreCondition: Customizing Failure Messages)\
[You can\'t reach the *target* through the
*container*](query.htm#touchobj) (Specials and the touchObj
PreCondition: Customizing Failure Messages)\
[you must choose in advance](webui.htm#choosing) (Choosing between the
regular UI and the Web UI)\

[]{#{}

## {

[{es/ed}](message.htm#regular-idx) (Conjugations and Tenses)\
[{ies/ies}](message.htm#regular-idx) (Conjugations and Tenses)\
[{present\|past}](message.htm#regular-idx) (Conjugations and Tenses)\
[{s/?ed}](message.htm#regular-idx) (Conjugations and Tenses)\
[{s/d}](message.htm#regular-idx) (Conjugations and Tenses)\
[{s/ed}](message.htm#regular-idx) (Conjugations and Tenses)\
:::
