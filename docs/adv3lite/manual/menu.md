...
[Table of Contents](toc.htm) \| [Optional Modules](core.htm) \> Menus  
[*Prev:* Gadgets](gadget.htm)     [*Next:* Hints](hint.htm)    
...
You could then call aboutMenu.display(); in the versionInfo.showAbout()
method.
