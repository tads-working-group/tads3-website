...
The point of separating [verify()]{.code} and [check()]{.code}, then, is
...
So far we have an example of how [verify()]{.code} is used. Let\'s
...
We can make one other consideration: let\'s say that the hand-held fan
