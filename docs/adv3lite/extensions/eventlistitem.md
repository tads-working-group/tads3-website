...
[Extensions](../../docs/manual/extensions.htm) \> EventListIem  
[*Prev:* Dynamic Region](dynregion.htm)     [*Next:*
Footnotes](footnotes.htm)    
...
- **underused()**: A method that returns true if this EventListItem item
  ...
  wish to define some other method of prioritization, such as fireCt ==
  0 (meaning that the EventListItem in question has never been used), so
  this is defined as a separate method to make it easy to customize.
...
*Adv3Lite Manual*  
[Table of Contents](../../docs/manual/toc.htm) \|
[Extensions](../../docs/manual/extensions.htm) \> EventListItem  
[*Prev:* Dynamic Region](dynregion.htm)     [*Next:*
Footnotes](footnotes.htm)    
