...
[*Prev:* Footnotes](footnotes.htm)     [*Next:*
MobileCollectiveGroup](mobilecollectivegroup.htm)    
...
- *Properties/Methods*: fuelSource, fuelLevel, showWarning(),
  sayBurnedOut(), burnedOutMsg, plungedIntoDarknessMsg, wontLightMsg,
  removeFuelSource()
...
- **fuelSource**: The object providing the fuel. By default this is nil,
  ...
  the external fuel source must supply the fuelLevel property.
...
- **sayBurnedOut()**: this is the message that's displayed when the
  ...
  - **burnedOutMsg**: this is the start of the message; it shouldn't be
    ...
    form is used, {the subj obj} will be replaced with the name of the
    object that's just gone out.
